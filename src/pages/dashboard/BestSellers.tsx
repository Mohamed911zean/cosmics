        ...
        return (
            <div className="flex items-center justify-center min-h-[400px]">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-gray-500 font-medium">Loading sales data from all users...</p>
                </div>
            </div>
        )
    }
        ...
        <div className="space-y-8">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500">Top performing products across all customers</p>
                </div>
            </div>
                ...
                <div className="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-gray-50/80 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500">Ranked by total sales from all customers</p>
                        </div>
                    </div>
                </div>
