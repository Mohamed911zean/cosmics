            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
                ...
                >
                    ...
                    <div className="prose prose-rose max-w-none text-gray-600">
                        <p className="lead">
                            At Velvet & Vine, we take your privacy seriously. This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from our store.
                        </p>
